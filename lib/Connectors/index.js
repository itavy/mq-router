 ...
 * @property {String} [queueDefinition.name=null] queue name for subscribing
 * @property {String} queueDefinition.rkey routing key under which it will subscribe
 * @property {Function} queueDefinition.handler handler to be called with received messages
 * @property {Number} [queueDefinition.limit=0] max number of messages to be processed
 * @property {Object} [queueDefinition.options={}] options for defining queue
 */
